...
5. To generate the denoised contact matrix, run `python denoise_contact.py` There will output figures named as "chr1_origin.png" and "chr1_my.png" produced in the root dir
